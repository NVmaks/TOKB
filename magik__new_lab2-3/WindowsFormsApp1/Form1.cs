...
namespace WindowsFormsApp1
{
    public partial class ZeroSector : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (error_num == 0)
            {
                ...
                using (FileStream disk = new FileStream(handle, FileAccess.Write))
                {
                    ...
                    button2.Enabled = false;
                    MessageBox.Show("Файлы на флешке доступны");
                }
                Hide();
                Form Form2 = new Form2();
                Form2.ShowDialog();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
           ...
           dwFlagsAndAttributes: FileAttributes.Normal,
            ...
            using (FileStream disk = new FileStream(handle, FileAccess.Write))
            {
                ...
                disk.Write(buffer0sector, 0, 512);
                button2.Enabled = false;
                MessageBox.Show("Пароль удалён из MBR, и вы вернули доступ к файлам");
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            disk_ch = comboBox1.SelectedItem.ToString();
            if (disk_ch != "") button1.Enabled = true;

        }

        // Заполнение ComboBox подключенными флешками
        private void usbDrives()
        {
            ...
            foreach (DriveInfo drive in DriveInfo.GetDrives())
            {
                ...
                {
                    comboBox1.Items.Add(drive.Name.Replace(":\\", ""));
                }
            }
        }
